        ...
        const alloc = await tx.commissionAllocation.create({
          data: {
            ...
            commissionRuleSnapshot: {
              ...
              basePercentageBps: rule.percentageBps,
              effectivePercentageBps: trace.effectivePercentageBps,
              thresholdCents: trace.thresholdCents,
              percentageBpsAtOrAboveThreshold: rule.percentageBpsAtOrAboveThreshold,
              thresholdApplied: trace.thresholdApplied,
