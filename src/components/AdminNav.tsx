...
export default function AdminNav({ labels = {} }: AdminNavProps) {
  ...
  const ALL_TABS = [
    { label: l.overview,     href: "/admin",                        roles: ["SUPERADMIN", "ADMIN_COMMERCIAL", "ADMIN_IR", "ADMIN_HR"] },
    { label: l.experiences,  href: "/admin/experiences",            roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.series,       href: "/admin/series",                 roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.profiles,     href: "/admin/profiles",               roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.sponsorship,  href: "/admin/sponsorship",            roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.analytics,    href: "/admin/analytics/experiences",  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.orders,       href: "/admin/orders",                 roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.memberships,  href: "/admin/memberships",            roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.menus,        href: "/admin/menus",                  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.irDocuments,  href: "/admin/ir",                     roles: ["SUPERADMIN", "ADMIN_IR"] },
    { label: l.hiring,       href: "/admin/hiring",                 roles: ["SUPERADMIN", "ADMIN_HR"] },
    { label: l.compensation, href: "/admin/compensation",           roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.partners,     href: "/admin/partners/reports",       roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: "Conversion",    href: "/admin/operations/conversion",  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    ...
    { label: l.revenue,             href: "/admin/revenue",              roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.revenueSessions,     href: "/admin/revenue/sessions",     roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.revenueObligations,  href: "/admin/revenue/obligations",  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.revenueReview,       href: "/admin/revenue/review",       roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: l.revenueEvents,       href: "/admin/revenue/events",       roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
    { label: "Payments",            href: "/admin/payments",                  roles: ["SUPERADMIN"] },
    { label: l.launchReadiness,     href: "/admin/launch-readiness",          roles: ["SUPERADMIN"] },
    { label: "Payouts",             href: "/admin/payouts",                   roles: ["SUPERADMIN", "ADMIN_COMMERCIAL", "ADMIN_FINANCE"] },
    { label: "Beneficiaries",       href: "/admin/payouts/beneficiaries",     roles: ["SUPERADMIN", "ADMIN_FINANCE"] },
    { label: "Tickets",             href: "/admin/tickets",                   roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
