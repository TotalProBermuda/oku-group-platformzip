...
const ACTION_CARDS: CardEntry[] = [
  { labelKey: "experiences",  descKey: "cardExperiencesDesc",  href: "/admin/experiences",           iconSrc: "/icons/flaticon/sparkle.png",   roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "series",       descKey: "browseSeries",         href: "/admin/series",                Icon: LayoutGrid,                          roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "analytics",    descKey: "cardAnalyticsDesc",    href: "/admin/analytics/experiences", iconSrc: "/icons/flaticon/analytics.png",  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "orders",       descKey: "cardOrdersDesc",       href: "/admin/orders",                iconSrc: "/icons/flaticon/orders.png",     roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "memberships",  descKey: "cardMembershipsDesc",  href: "/admin/memberships",           iconSrc: "/icons/flaticon/crown.png",      roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "menus",        descKey: "cardMenusDesc",        href: "/admin/menus",                 Icon: LayoutGrid,                          roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "users",        descKey: "cardUsersDesc",        href: "/admin/users",                 iconSrc: "/icons/flaticon/users.png",      roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "payouts",      descKey: "cardPayoutsDesc",      href: "/admin/payouts",               iconSrc: "/icons/flaticon/briefcase.png",  roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
  { labelKey: "revenueTrust", descKey: "cardRevenueTrustDesc", href: "/admin/revenue",               iconSrc: "/icons/flaticon/wallet.png",     roles: ["SUPERADMIN", "ADMIN_COMMERCIAL"] },
