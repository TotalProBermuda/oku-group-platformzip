...
const EMPLOYEE_PERSONAS = [
  ...
  { email: "commercial@oku.local",  label: "Admin Commercial",  descKey: "personaAdminCommercialDesc",   color: "#7c3aed", tag: "ADMIN",        destination: "/admin" },
  ...
  { email: "host1@oku.local",       label: "Rafael Núñez",      descKey: "personaRestaurantHostDesc",    color: "#c8a96e", tag: "HOST",         destination: "/host/dashboard" },
